...
LL n, m;
vector<LL> gr[SIZE];
vector<LL> transGr[SIZE];
vector<LL> nodeVec;


LL visAr[SIZE], compoAr[SIZE];
...
//            DBG2(u, v);
            ...
            gr[AD-u].push_back( AD+v );
            gr[AD-v].push_back( AD+u );

            transGr[AD+v].push_back( AD-u );
            transGr[AD+u].push_back( AD-v );
        }
...
//        cout << "printing rev nodeVec " << endl;
//        prVec( nodeVec );
