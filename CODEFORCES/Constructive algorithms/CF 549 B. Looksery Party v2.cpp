...
LL getZeroIdx()
{
 ...
 void modifyMsgCnt( const VL &contactList )
 {
...
//    freopen("input.txt", "r", stdin);
    ...
    while( getZeroIdx() != -1 )
    {
        LL zeroIdx = getZeroIdx();
        ansVec.push_back( zeroIdx );
        VL contactList = getContactList(zeroIdx);
        modifyMsgCnt(contactList);
    }
