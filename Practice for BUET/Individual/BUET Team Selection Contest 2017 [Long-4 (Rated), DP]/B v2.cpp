...
LL getDp(LL numZero, LL digitsRem)
{
//    DBG2(numZero, digitsRem);
    LL ret = 0;
    if ( digitsRem == 0 )
    {
//        cout << "returing 1" << endl;
    ...
    if ( dp[ numZero ][ digitsRem ] == -1 )
    {
        if ( numZero == 0 )
        {
//            ret += (K-1) * dp[0][digitsRem-1];
//            ret += dp[1][ digitsRem-1 ];

            ret += (K-1) * getDp(0, digitsRem-1);
            ret += getDp(1, digitsRem-1);
        }
        else if ( numZero == 1 )
        {
//            ret += (K-1) * dp[0][ digitsRem-1 ];
        ...
        dp[ numZero ][ digitsRem ] = ret;
    }
//    cout << "returing " << dp[ numZero ][ digitsRem ] << endl;
    return dp[ numZero ][ digitsRem ];
}
